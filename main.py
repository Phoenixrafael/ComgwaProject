...
terrainDict[(3, 0)] = getSpriteFromTileMap(terrain, 0, 5)
terrainDict[(3, 0, 0)] = getSpriteFromTileMap(terrain, 3, 7)
terrainDict[(3, 0, 1)] = getSpriteFromTileMap(terrain, 0, 7)
terrainDict[(3, 1, 0)] = getSpriteFromTileMap(terrain, 2, 7)
terrainDict[(3, 1, 1)] = getSpriteFromTileMap(terrain, 1, 7)
